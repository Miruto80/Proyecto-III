...
<head>
  ...
  <title> Reserva | LoveMakeup  </title> 
</head>
  ...
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Reserva</li>
      </ol>
      <h6 class="font-weight-bolder text-white mb-0">Gestionar Reserva</h6>
    </nav>
<!-- php barra de navegacion-->    
...
<div class="container-fluid py-4"> <!-- DIV CONTENIDO -->
    ...
    <!--Titulo de página -->
     <div class="d-sm-flex align-items-center justify-content-between mb-5">
       <h4 class="mb-0"><i class="fa-solid fa-chalkboard-user mr-2" style="color: #f6c5b4;"></i>
        Reserva</h5>
...
<div class="modal fade" id="registro" tabindex="1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered">
    ...
    <div class="modal-header header-color">
        <h1 class="modal-title fs-5" id="1">Registrar reserva</h1>
