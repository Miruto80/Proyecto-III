...
<button type="button" id="btn-vaciar-deseos" class="btn btn-outline-danger w-100 mt-2">
    <i class="fa fa-trash me-2"></i> Vaciar lista de deseos
</button>
...
<?php include 'vista/complementos/footer_catalogo.php' ?>
 <script src="assets/js/catalogo_lista.js"></script>
