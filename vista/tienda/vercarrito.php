...
<section id="latest-blog" class="section-padding pt-0">
  ...
  <div class="cart-step">
    ...
    <?php if (empty($carrito)): ?>
        <div class="container" style=" border: 1px solid #ccc;border-top-left-radius:5px;border-top-right-radius:5px; padding:10px; display:flex;flex-direction: column;
            ...
            <table class="table table-bordered align-middle">
                ...
                <tbody>
                    ...
                    <button class="btn-eliminar" data-id="<?php echo $id; ?>" ><i class="fa-solid fa-x"></i></button>
                        ...
                        <td>
                            <img src="<?= htmlspecialchars($item['imagen']) ?>" class="img-thumbnail" width="60">
                        </td>
                        <td>
                        ...
                        <td class="quantity-control">
                            <div class="d-flex align-items-center">
                                ...
                                <button class="btn btn-outline-secondary btn-sm btn-mas" data-id="<?= $id ?>">+</button>
                            </div>
                        </td>
